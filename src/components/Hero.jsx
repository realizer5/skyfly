...
export default function Hero({ heroImg, title, text, url, btnText }) {
    return (
        <div className="w-full h-screen relative flex justify-center items-center">
            ...
            <div className="absolute w-full">
                <h1 className="text-5xl font-extrabold text-white bg-clip-text fill-transparent py-3 px-5 md:py-0 md:px-0">{title}</h1>
